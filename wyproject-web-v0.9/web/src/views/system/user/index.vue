    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
              ...
              <el-collapse-item :title="'用户统计：' + total + '人'">
                <div class="collapse-content">
                  ...
                  <el-descriptions title="">
                    <el-descriptions-item v-for="(item, index) in peopleTotalInfo" :key="index" :label="item.postName">{{
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="info" plain icon="el-icon-upload2" size="mini" :disabled="true" @click="handleImport"
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="手机号码" align="center" key="phonenumber" prop="phonenumber" v-if="columns[4].visible"
            width="120" />
          <el-table-column label="邮箱" align="center" key="email" prop="email" v-if="columns[4].visible" width="160" />

          <el-table-column label="角色" align="center" key="roleName" prop="roleName" width="120" v-if="columns[3].visible"
            :show-overflow-tooltip="true" />
          <el-table-column label="最后登录" align="center" prop="loginDate" v-if="columns[6].visible" width="160">
