  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="device !== 'mobile'">
        ...
        <!-- <span style="height:56px !important;margin:0 auto;line-height:50px;margin-bottom:50%">
        ...
        <el-tooltip content="欢迎使用！" placement="bottom">
          <!-- <span class="right-menu-item hover-effect">下午好，二狗子！</span> -->
          <span class="right-menu-item hover-effect"
            >{{ usertime }},{{ username }}！</span
          >
